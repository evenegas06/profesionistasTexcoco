...
<body class="container">
    ...
    <header class="columna2" id="overlay">
        ...
        <nav id="sidebar">
            <ul class="">
                ...
                <li>
                    <a href="https://news.carlosarturomt.com"> <span class="news"></span> Noticias</a>
                </li>
                <li>
                    <a href="https://carlosarturomt.com/contacto"> <span class="user"></span> Contacto</a>
                </li>
                <li class="buttonStyle li-p" id="theme" aria-label="Dark Theme">
                    <p>
                        <span class="theme"></span> Tema
                    </p>
                </li>
            </ul>
        </nav>
    ...
    <main class="columna1">
        <aside class="">
            <img class="container-profile--cover" src="https://wc.wallpaperuse.com/wallp/80-801973_s.jpg"
                alt="Psicólgo Carlos Arturo Miranda Trujano">
        </aside>
        ...
        <section class="container-grid container-profile">
            ...
            <article class="row" data-categoria="psicólogos"
                data-etiquetas="Psicología psicología Psicologia psicologiaPsicólogo psicólogo Psicologo psicologo cognitivo conductual   Cognitivo Conductual Ansiedad ansiedad Depresión depresion Depresion depresión terapia Terapia Rendimiento Atención CI coeficiente Escuela escuela educación Educación Maestro maestro Educativo educativo Desarrollo desarrollo web Web Frontend frontend"
                data-descripcion="El licenciado Carlos es un psicólogo con especialidad en Educación, conocimientos en desarrollo web y apasionado del conocimiento.">
                ...
                <aside class="container-inf--card col-12">
                    <article>
                        ...
                        <p><a href="https://www.google.com/maps/place/Consciente+Colectivo/@19.5104491,-98.8804663,19z/data=!4m5!3m4!1s0x85d1e7b350eeaaab:0x42c02f89b3a284e9!8m2!3d19.5104161!4d-98.8798142?hl=en"
                                target="_blank" rel="noopener"><span class="map"></span>Aldama 148 col el Carmen,
                                Texcoco</a></p>
                    </article>
                </aside>
                    ...
                    <section class="plans-container--slider">
                        <article class="plans-container--card">
                            <aside class="card-profile--inf">
                                ...
                                <button class="plan-card--ca" id="openPopup1"> <p>Agendar Cita <span></span></p> </button>
                            </aside>
                        </article>
                        <article class="plans-container--card">
                            <aside class="card-profile--inf">
                                ...
                                <button class="plan-card--ca" id="openPopup2"> <p>Agendar Cita <span></span></p> </button>
                            </aside>
                        </article>
                        <article class="plans-container--card">
                            <aside class="card-profile--inf">
                                ...
                                <button class="plan-card--ca" id="openPopup3"> <p>Agendar Cita <span></span></p> </button>
                            </aside>
                        </article>
                        <article class="plans-container--card">
                            <aside class="card-profile--inf">
                                ...
                                <button class="plan-card--ca" id="openPopup4"> <p>Agendar Cita <span></span></p> </button>
                            </aside>
                        </article>
                        <article class="plans-container--card">
                            <aside class="card-profile--inf">
                                ...
                                <button class="plan-card--ca" id="openPopup5"> <p>Agendar Cita <span></span></p> </button>
                            </aside>
                        </article>
                    </section>
                </section>
    ...
    <!-- F O R M - D A T E  -->
        <aside class="overlay-popup" id="overlayPopup">
        ...
        <aside>
            ...
            <article>
                ...
                <a href="https://carlosarturomt.com">
                    <p><span class="user1"></span> carlosArturoMT</p>
                </a>
            </article>
        </aside>
...
<?php
    ...
    if (isset($_POST['btn-submit'])) {
        ...
        if ($mail1) {
            ...
            echo "<h2>Mensaje enviado, gracias por contactarnos.</h2>";
                echo "<meta http-equiv='refresh' content='60,url=carlosarturomt.php'>";
        } else {
    ...
    if (isset($_POST['btn-submit1'])) {
        ...
        if ($mail2) {
            ...
            echo "<h2>Mensaje enviado, gracias por contactarnos.</h2>";
                echo "<meta http-equiv='refresh' content='900,url=carlosarturomt.php'>";
        } else {
            echo "No se ha podido enviar tu mensaje, intentalo mas tarde";
        }
    }
